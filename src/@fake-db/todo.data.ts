export class TodoFakeData {
  public static tasks = [
    {
      id: 1,
      title: 'Entire change break our wife wide Items daughter mention member.',
      dueDate: '2020-11-25',
      description:
    ...
    {
      id: 9,
      title: 'Finish documentation and make Items live',
      dueDate: '2020-11-25',
      description:
        '<p>Chocolate cake topping bonbon jujubes donut sweet wafer. Marzipan gingerbread powder brownie bear claw. Chocolate bonbon sesame snaps jelly caramels oat cake.</p>',
      assignee: {
    ...
    {
      id: 10,
      title: 'List out all the SEO resources and send Items to new SEO team. ',
      dueDate: '2020-12-09',
      description:
        '<p>Chocolate cake topping bonbon jujubes donut sweet wafer. Marzipan gingerbread powder brownie bear claw. Chocolate bonbon sesame snaps jelly caramels oat cake.</p>',
      assignee: {
    ...
    {
      id: 11,
      title: 'Refactor Code and fix the bugs and test Items on server ',
      dueDate: '2020-12-01',
      description:
        '<p>Chocolate cake topping bonbon jujubes donut sweet wafer. Marzipan gingerbread powder brownie bear claw. Chocolate bonbon sesame snaps jelly caramels oat cake.</p>',
      assignee: {
    ...
    {
      id: 13,
      title: "Submit quotation for Abid's Home website and admin project",
      dueDate: '2020-12-01',
      description:
        '<p>Chocolate cake topping bonbon jujubes donut sweet wafer. Marzipan gingerbread powder brownie bear claw. Chocolate bonbon sesame snaps jelly caramels oat cake.</p>',
      assignee: {
