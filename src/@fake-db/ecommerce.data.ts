export class EcommerceFakeData {
  public static products = [
    ...
    },
    {
      ...
      description:
        'With unique inspirational quote and time markers on Items,this water bottle is great for measuring your daily intake of water,reminding you stay hydrated and drink enough water throughout the day.A must have for any fitness goals including weight loss,appetite control and overall health.',
      brand: '3M',
      price: 16.99,
    ...
    },
    {
      ...
      description:
        'Charge with case: transmits charging power directly through protective cases. Rubber/plastic/TPU cases under 5 mm thickness . Do not use any magnetic and metal attachments or cards, or Items will prevent charging.',
      brand: '3M',
      price: 10.83,
    ...
    {
      id: 21,
      name: 'Google - Google Items - White/Slate fabric',
