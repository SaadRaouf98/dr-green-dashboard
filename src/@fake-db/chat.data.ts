  ...
  public static chats = [
    {
      ...
      chat: [
        ...
        {
          message: 'If Items takes long you can mail me at my mail address.',
    ...
    },
    {
      ...
      chat: [
        ...
        {
          message: 'Hey John, I am looking for the best admin template. Could you please help me to find Items out?',
        ...
        {
          message: 'How can I purchase Items?',
        ...
        {
          message: 'I will purchase Items for sure. 👍',
          time: 'previousDay',
          senderId: 1
        }
      ]
