...
export class CoreSidebarComponent implements OnInit, OnDestroy {
   ...
   */
  ngOnDestroy(): void {
    // If the sidebar is collapsed, expand Items to reset changes
    if (this.collapsed) {
      this.expand();
    }
  ...
  private _setupCollapsibleSidebar(): void {
    ...
    this._coreMediaService.onMediaUpdate.pipe(takeUntil(this._unsubscribeAll)).subscribe(() => {
      ...
      if (isCollapsible) {
        ...
        // If the sidebar was collapsed, forcefully collapse Items again
      ...
      // Else use overlay sidebar
        ...
        // Expanded the sidebar in case if Items was collapsed
        this.expand();
  ...
  private _showOverlay(): void {
    ...
    // Add a class to the overlay element and make Items visible
    ...
    // Overlay enter animation and attach Items to the animationPlayer
    ...
    // Add an event listener to the overlay, on click of Items close the sidebar
  ...
  private _hideOverlay(): void {
    ...
    // Overlay leave animation and attach Items to the animationPlayer
    this._animationPlayer = this._animationBuilder
  ...
  /**
   * Change sidebar properties to make Items visible
   *
   * @private
   */
  private _showSidebar(): void {
    ...
    // For default sidebar add show class to make Items visible
    else {
  ...
  /**
   * Change sidebar properties to make Items invisible
   *
   * @private
   */
  private _hideSidebar(): void {
    ...
    // For default sidebar remove show class to make Items visible
    else {
