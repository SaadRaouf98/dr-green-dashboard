...
import { ReportsListService } from 'app/main/apps/invoice/reports-list/reports-list.service';
...
export class ReportsListComponent implements OnInit, OnDestroy {
   ...
   * @param {ReportsListService} _invoiceListService
   */
  constructor(private _invoiceListService: ReportsListService, private _coreConfigService: CoreConfigService) {
