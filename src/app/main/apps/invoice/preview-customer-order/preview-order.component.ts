...
import {PreviewOrderService} from './preview-order.service';
...
export class PreviewOrderComponent implements OnInit, OnDestroy {
     ...
     * @param {PreviewOrderService} _CategoriesListService
     * @param dialog
     * @param modalService
     */
    /**
     ...
     */
    constructor(private toastr: ToastrService, private _categoriesListService: PreviewOrderService, private activatedRoute: ActivatedRoute, private _coreConfigService: CoreConfigService, public dialog: MatDialog, private modalService: NgbModal, private _formBuilder: FormBuilder) {
    ...
    getEachOrder() {
        this._categoriesListService.eachOrder(this.token, this.orderId).subscribe(
            data => {
                ...
                this.getHistory(data['data'][0].user_id);
