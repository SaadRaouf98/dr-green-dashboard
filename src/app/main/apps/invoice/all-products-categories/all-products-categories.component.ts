...
import {AllProductsCategoriesService} from './all-products-categories.service';

@Component({
    selector: 'app-all-products-Categories',
    templateUrl: './all-products-categories.component.html',
    styleUrls: ['./all-products-categories.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class AllProductsCategoriesComponent implements OnInit, OnDestroy {
    // public
    token: any;
    id: any;
     ...
     * @param {AllProductsCategoriesService} _CategoriesListService
     * @param dialog
     * @param modalService
     */
    /**
     ...
     */
    constructor(
        private _categoriesListService: AllProductsCategoriesService,
