...
import {DashboardCustomersOrderListService} from './dashboard-customers-order-list.service';
...
@Component({
    selector: 'app-dashboard-customers-order-list',
    templateUrl: './dashboard-customers-order-list.component.html',
    styleUrls: ['./dashboard-customers-order-list.component.scss'],
    animations: [repeaterAnimation],
    encapsulation: ViewEncapsulation.None
})
export class DashboardCustomersOrderListComponent implements OnInit, OnDestroy {
    // Public
    token: any;
    id: any;
    dateFrom: any;
    ...
    constructor(
        ...
        private _productsAdditionFormService: DashboardCustomersOrderListService,
    ...
    getBackOrders() {
        this._productsAdditionFormService.backOrders(this.token).subscribe(
            data => {
                this.backOrders = data['data'];
                console.log(this.backOrders);
            },
            error => {
                console.log(error);
    ...
    addBacksToCart(id) {
        this._productsAdditionFormService.addBack(this.token, id).subscribe(
            data => {
                this.backOrders = data['data'];
                console.log(this.backOrders);
