...
import {WebsiteCustomersListService} from './website-customers-list.service';
import {ModalDismissReasons, NgbModal} from '@ng-bootstrap/ng-bootstrap';
import {FormBuilder, FormGroup, Validators} from '@angular/forms';

@Component({
    selector: 'app-website-customers-list',
    templateUrl: './website-customers-list.component.html',
    styleUrls: ['./website-customers-list.component.scss'],
    animations: [repeaterAnimation],
    encapsulation: ViewEncapsulation.None
})
export class WebsiteCustomersListComponent implements OnInit, OnDestroy {
    // Public
    token: any;
    customers: any;
    id: any;
    ...
    constructor(
        ...
        private _productsAdditionFormService: WebsiteCustomersListService,
