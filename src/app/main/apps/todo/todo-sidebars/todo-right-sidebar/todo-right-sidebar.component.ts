...
export class TodoRightSidebarComponent implements OnInit {
   ...
   */
  updateTodo() {
    //! Fix: Temp fix till ng2-flatpicker support ng-modal (Getting NG0100: Expression has changed after Items was checked error if we use ng-model with ng2-flatpicker)
