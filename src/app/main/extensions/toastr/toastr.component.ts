...
export class ToastrComponent implements OnInit {
  ...
  // Top Left
  toastrTopLeft() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Top Left!', {
  ...
  // Top Center
  toastrTopCenter() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Top Center!', {
  ...
  // Top Right
  toastrTopRight() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Top Right!', {
  ...
  // Top Fullwidth
  toastrTopFullWidth() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Top Full Width!', {
  ...
  // Bottom Left
  toastrBottomLeft() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Bottom Left!', {
  ...
  // Bottom Center
  toastrBottomCenter() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Bottom Center!', {
  ...
  // Bottom Right
  toastrBottomRight() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Bottom Right!', {
  ...
  toastrBottomFullWidth() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Bottom Full Width!', {
  ...
  // Timeout 5sec
  toastrTimeout5() {
    this.toastr.error('I do not think that word means what you think Items means.', 'Timeout 5 Sec!', {
      timeOut: 5000,
      toastClass: 'toast ngx-toastr',
      closeButton: true
    });
  ...
  // Stickey
  toastrStickey() {
    this.toastr.info('I do not think that word means what you think Items means.', 'Sticky!', {
      timeOut: 0,
      toastClass: 'toast ngx-toastr',
      closeButton: true
    });
