...
@Component({
  ...
  selector: 'app-checkout-cart-vendors',
  templateUrl: './checkout-cart-vendors.component.html',
  styleUrls: ['./checkout-cart-vendors.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CheckoutCartVendorsComponent implements OnInit {
  // Decorator
