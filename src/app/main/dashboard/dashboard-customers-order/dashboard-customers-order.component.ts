...
@Component({
  selector: 'app-dashboard-customers-order',
  templateUrl: './dashboard-customers-order.component.html',
  styleUrls: ['./dashboard-customers-order.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DashboardCustomersOrderComponent implements OnInit {
  // Decorator
