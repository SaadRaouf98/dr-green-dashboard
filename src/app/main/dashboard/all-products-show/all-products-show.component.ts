...
@Component({
  selector: 'app-all-products-show',
  templateUrl: './all-products-show.component.html',
  styleUrls: ['./all-products-show.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AllProductsShowComponent implements OnInit {
  // Decorator
