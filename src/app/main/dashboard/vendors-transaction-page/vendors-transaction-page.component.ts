...
@Component({
  selector: 'app-vendors-transaction-page',
  templateUrl: './vendors-transaction-page.component.html',
  styleUrls: ['./vendors-transaction-page.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class VendorsTransactionPageComponent implements OnInit {
  // Decorator
