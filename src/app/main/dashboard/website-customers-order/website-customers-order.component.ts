...
@Component({
    selector: 'app-website-customers-order',
    templateUrl: './website-customers-order.component.html',
    styleUrls: ['./website-customers-order.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class WebsiteCustomersOrderComponent implements OnInit {
    // Decorator
