...
@Component({
  selector: 'app-show-products-low',
  templateUrl: './show-products-low.component.html',
  styleUrls: ['./show-products-low.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ShowProductsLowComponent implements OnInit {
  // Decorator
