 ...
 * You can also change them on each component basis. i.e `app/main/pages/authentication/auth-login-v1/plz-verify.component.ts`
 *
 ...
 *  ! Otherwise, Items will not take the below config changes and use stored config from local storage.
 *
 */
...
export const coreConfig: CoreConfig = {
  app: {
    appName     : 'SN Photo inc',                                        // App Name
    appTitle    : 'SN Photo inc', // App Title
    appLogoImage: 'assets/images/logo/SNphotos.png',                  // App Logo
